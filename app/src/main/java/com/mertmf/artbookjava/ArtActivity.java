package com.mertmf.artbookjava;
...
import com.mertmf.artbookjava.databinding.ActivityArtBinding;
import com.mertmf.artbookjava.databinding.ActivityMainBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<String> permissionLauncher;   //İzni istemek için
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(info.equals("new")) {
            ...
            binding.imageView.setImageResource(R.drawable.selectimage3);
    ...
    public  void  save(View view) {
        ...
        smallImage.compress(Bitmap.CompressFormat.PNG,50,outputStream);
           ...
           intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); //Tüm Aktiviteleri kapat yeni açtığım aktiviteyi çalıştır.
